...
#define MAX_INVENTORY 150 ///Maximum items in player inventory
...
#define MAX_SLOTS 4
#define MAX_AMOUNT 9999 ////Max amount of a single stacked item
...
#define DEFAULT_WALK_SPEED 160 ///Default walk speed
